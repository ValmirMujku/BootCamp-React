...
export default function EachApi() {
  ...
  return (
    <>
      {allApi &&
        allApi.map((dt) => (
          <tr key={dt.Link} className="bg-dark">
            <th className="text-light" scope="row">
              {count++}
            </th>
            <td className="bg-secondary fst-italic fw-bold">
              <i
                className="fa fa-arrow-circle-right text-light"
                aria-hidden="true"
              ></i>{" "}
              {dt.API}
            </td>
            ...
            <td className="bg-secondary">
              ...
              >
                <i class="fa fa-file-code-o" aria-hidden="true"></i> {dt.Link}
              </a>
            </td>
