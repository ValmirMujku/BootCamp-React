  ...
  return (
    <>
      <div className="d-flex justify-content-center align-items-center flex-column mt-5 mb-5">
        <div
          className="border border-secondary w-50 d-flex justify-content-center align-items-center flex-column bg-body"
          style={{ boxShadow: "10px 10px 5px grey" }}
        >
          <div className="text-center text-dark">
            <h2>
              <span className="text-danger">{"{"}</span>Credit-Card Details
